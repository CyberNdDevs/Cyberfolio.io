...
const TeamBody = () => {
  const [team_members, setteam_members] = useState([
    ...
    },
    {
      ...
      description: "Archana, a cybersecurity consultant, specializes in Android, web, API, and network VAPT. Passionate about exploring new cybersecurity domains, she continuously expands her expertise to stay ahead in the digital landscape.",
